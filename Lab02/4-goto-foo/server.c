...
{ 
    ...
    { 
      strcpy(error_buffer, "Socket creation error\n");
      goto exit_error;
		    /* Your code for socker creation error */
    ...
    if (bind(server_fd, (struct sockaddr *)&address,  
                                 sizeof(address))<0) 
    {
    	strcpy(error_buffer, "Invalid bind error\n");
    	goto exit_error;
    ...
    { 
    	strcpy(error_buffer, "Invalid listen error\n");
    	goto exit_error;
    ...
    if ((new_socket = accept(server_fd, (struct sockaddr *)&address,  
                       (socklen_t*)&addrlen))<0) 
    { 
    	strcpy(error_buffer, "Invalid accept error\n");
    	goto exit_error;
